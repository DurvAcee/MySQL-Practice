...
-- nested where clause with AND operator
select * from products
where price = 3.00
and coffee_origin = 'Colombia';

-- nested where clause with OR operator
select * from products
where price = 3.00
or coffee_origin = 'Colombia';


-- Inequality symbols in where
select * from products;
...
-- Select data which has null values
select * from customers
where phone_number is null;

-- Select data which does not have null values
select * from customers
where phone_nuber is not null;
